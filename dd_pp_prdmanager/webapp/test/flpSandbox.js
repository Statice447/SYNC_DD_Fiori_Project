		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ddppprdmanager-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ddppprdmanager-display": {
								"semanticObject": "ddppprdmanager",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ddppprdmanager",
									"url": sap.ui.require.toUrl("ddppprdmanager")
								}
							}
						}
					}
